...
for image_class in os.listdir(data_dir):
    for image in os.listdir(os.path.join(data_dir, image_class)):
        ...
        #label = assign_label(image, image_class)
        try:
...
def fix_image_files(root=os.data_dir):
...
if yhat > 0.5:
    print(f'Predicted class is Sun')
else:
